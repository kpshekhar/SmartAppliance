...
//
//mysql_query("DROP SCHEMA APPLIANCE_DB");
mysql_query("DROP SCHEMA appliance_db");
// Create database
  if (!mysql_select_db('appliance_db', $con)) {
    echo("Creating Database 'appliance_db'!\n<br>");
    if (mysql_query("CREATE DATABASE appliance_db",$con)){ echo "Database created<br>";}
	else { echo "Error creating database: " . mysql_error() . "<br>";}

	mysql_select_db("appliance_db", $con);
  }

$sql5= "CREATE TABLE appliance_data
(
 
  userid varchar(45) DEFAULT NULL,
  serialno int(11) NOT NULL AUTO_INCREMENT,
  appliancename varchar(50) DEFAULT NULL,
  energy decimal(10) NOT NULL,
  phase int(10) DEFAULT '0.0',
  operationtime int(10) NOT NULL,
  userstarttime varchar(50) DEFAULT NULL,
  userendtime varchar(50) DEFAULT NULL,
  phaseseqno int(10) DEFAULT '0.0',
  hardsoftconst varchar(45) DEFAULT NULL,
  scheduledstarttime varchar(50) DEFAULT NULL,
  scheduledendtime varchar(50) DEFAULT NULL,
  cost decimal(10,4) DEFAULT '0.0',
  proposedstarttime varchar(50) DEFAULT NULL,
  proposedendtime varchar(50) DEFAULT NULL,
  proposedcost decimal(10,4) DEFAULT '0.0',
